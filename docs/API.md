...
- [API Reference](#api-reference)
  ...
  - [Resolution Functions](#resolution-functions)
    - [order2nside](#order2nside)
    - [nside2order](#nside2order)
    - [nside2npix](#nside2npix)
    - [nside2pixarea](#nside2pixarea)
    - [nside2resol](#nside2resol)
  - [Position ↔ Pixel Index](#position--pixel-index)
    - [ang2PixNest / ang2PixRing](#ang2pixnest--ang2pixring)
    - [pix2AngNest / pix2AngRing](#pix2angnest--pix2angring)
    - [vec2PixNest / vec2PixRing](#vec2pixnest--vec2pixring)
    - [pix2VecNest / pix2VecRing](#pix2vecnest--pix2vecring)
  - [Geographic Coordinates](#geographic-coordinates)
    - [lonLat2PixNest / lonLat2PixRing](#lonlat2pixnest--lonlat2pixring)
    - [pix2LonLatNest / pix2LonLatRing](#pix2lonlatnest--pix2lonlatring)
    - [vec2LonLat](#vec2lonlat)
  - [Scheme Conversion](#scheme-conversion)
    - [nest2ring](#nest2ring)
    - [ring2nest](#ring2nest)
    - [orderpix2uniq](#orderpix2uniq)
    - [uniq2orderpix](#uniq2orderpix)
  - [Pixel Geometry](#pixel-geometry)
    - [cornersNest / cornersRing](#cornersnest--cornersring)
    - [cornersNestLonLat / cornersRingLonLat](#cornersnestlonlat--cornersringlonlat)
    - [pixcoord2VecNest / pixcoord2VecRing](#pixcoord2vecnest--pixcoord2vecring)
  ...
  - [Hierarchical Operations](#hierarchical-operations)
    ...
    - [nestAncestor](#nestancestor)
    - [nestDescendants](#nestdescendants)
    - [isNestAncestor](#isnestancestor)
    - [uniqParent](#uniqparent)
    - [uniqChildren](#uniqchildren)
  - [Spatial Queries](#spatial-queries)
    - [queryDiscInclusiveNest / queryDiscInclusiveRing](#querydiscinclusivenest--querydiscinclusivering)
    - [queryBoxInclusiveNest / queryBoxInclusiveRing](#queryboxinclusivenest--queryboxinclusivering)
  - [Coordinate Transformations](#coordinate-transformations)
    - [vec2za / za2vec](#vec2za--za2vec)
    - [ang2vec / vec2ang](#ang2vec--vec2ang)
    - [za2tu / tu2za](#za2tu--tu2za)
    - [tu2fxy / fxy2tu](#tu2fxy--fxy2tu)
    - [fxy2nest / nest2fxy](#fxy2nest--nest2fxy)
    - [fxy2ring / ring2fxy](#fxy2ring--ring2fxy)
  - [Bit Operations](#bit-operations)
    - [bitCombine](#bitcombine)
    - [bitDecombine](#bitdecombine)
